...
fetch('https://johu-coffee-backend.vercel.app/coffees',{
  method: 'POST',
  headers:{
...
.then(data => {
  ...
  return (
    <div className="w-full h-auto bg-[url('https://i.postimg.cc/66FBrVVq/add-bg.png')] bg-no-repeat bg-cover bg-center py-10">
      <div onClick={()=>navigate('/')} className='flex items-center gap-2 w-[80%] mx-auto py-10 cursor-pointer'>
...
<span className='text-[#331A15] font-rancho text-2xl'>Back to home</span>
      ...
      <form onSubmit={handleAddCoffee} className='w-[80%] mx-auto bg-[#F4F3F0] rounded-md px-5 py-5'>
        <h1 className='text-[#331A15] font-rancho text-3xl text-center mb-3'>Add New Coffee</h1>
...
<label className="form-control w-full lg:col-span-1 col-span-2">
  ...
  <input type="text" name='photo' placeholder="Enter Coffee Photo" className="input input-bordered w-full" required/>
</label>
<button className="bg-[#E3B577] font-rancho text-[#242222] text-xl px-4 py-2 rounded-md flex items-center gap-2 col-span-2 w-full justify-center my-5">
